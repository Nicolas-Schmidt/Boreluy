...
Este paquete de R proporciona un conjunto de datos que comtiene resultados electorales al maximo nivel de desagregacion posible y comparable entre elecciones. Adicionalmente provee un conjunto de funciones que permiten obtener agregaciones de los datos (resultado por partido, por partido-departamento...). 
