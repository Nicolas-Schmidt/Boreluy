...
Esta
[**aplicación**](https://bancodedatos-fcs.shinyapps.io/appPolitica/) fue
desarrollada por la UMAD (Unidad de Métodos y Acceso a Datos). En esta
aplicación no solo van a encontrar datos electorales sino que también
van a encontrar datos de opinión Pública en Uruguay del paquete de R
[opuy](https://nicolas-schmidt.github.io/opuy/) (Schmidt, Vairo, Opertti
(2020)).
...
Para citar el paquete `Boreluy` o el uso de los datos en publicaciones
use:
